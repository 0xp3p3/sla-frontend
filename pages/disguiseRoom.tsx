...
const DisguiseRoom: NextPage = () => {
  return (
    <PageWrapper title="The Disguise Room" webflowPageId="622dfe66d1256c4dfaba1442">
        ...
        <div className="container-m relative w-container">
          <div className="vert-cent">
            ...
            <div className="vert-left stretch">
              ...
              <p className="p1 p-white">Every trait will cost you 2 $HAY. Select your Llama Agent from the dropdown list below, then you can start the minting process. </p>
            </div>
            <div className="w-layout-grid grid-2">
              ...
              <div id="w-node-c51ac5e2-ed2e-9254-8fc8-bd71e7d815f6-faba1442" className="vert-left space-btw h-472">
                <div className="vert-left">
                  <div className="img-bg"><img src="images/Skin-15---Tiger.png" loading="lazy" sizes="(max-width: 991px) 200px, 330px" srcSet="images/Skin-15---Tiger-p-500.png 500w, images/Skin-15---Tiger-p-800.png 800w, images/Skin-15---Tiger.png 1000w" alt="" className="llama-img select dis" /></div>
                </div>
              ...
              <div id="w-node-c51ac5e2-ed2e-9254-8fc8-bd71e7d81601-faba1442" className="vert-left space-btw h-472">
                <div className="vert-left">
                  <div className="img-bg"><img src="images/Eyes-34---Green-Frame.png" loading="lazy" sizes="(max-width: 991px) 200px, 330px" srcSet="images/Eyes-34---Green-Frame-p-500.png 500w, images/Eyes-34---Green-Frame-p-800.png 800w, images/Eyes-34---Green-Frame.png 1000w" alt="" className="llama-img select dis" /></div>
                </div>
              ...
              <div id="w-node-c51ac5e2-ed2e-9254-8fc8-bd71e7d8160e-faba1442" className="vert-left space-btw h-472">
                <div className="vert-left">
                  <div className="img-bg"><img src="images/Mouth-06---Smoking-Marijuana.png" loading="lazy" sizes="(max-width: 991px) 200px, 330px" srcSet="images/Mouth-06---Smoking-Marijuana-p-500.png 500w, images/Mouth-06---Smoking-Marijuana-p-800.png 800w, images/Mouth-06---Smoking-Marijuana.png 1000w" alt="" className="llama-img select dis" /></div>
                </div>
              ...
              <div id="w-node-c51ac5e2-ed2e-9254-8fc8-bd71e7d8161b-faba1442" className="vert-left space-btw h-472">
                <div className="vert-left">
                  <div className="img-bg"><img src="images/Clothing-13---Cowboy.png" loading="lazy" sizes="(max-width: 991px) 200px, 330px" srcSet="images/Clothing-13---Cowboy-p-500.png 500w, images/Clothing-13---Cowboy-p-800.png 800w, images/Clothing-13---Cowboy.png 1000w" alt="" className="llama-img select dis" /></div>
                </div>
              ...
              <div id="w-node-c51ac5e2-ed2e-9254-8fc8-bd71e7d81628-faba1442" className="vert-left space-btw h-472">
                <div className="vert-left">
                  <div className="img-bg"><img src="images/Hat-05---Crown.png" loading="lazy" sizes="(max-width: 991px) 200px, 330px" srcSet="images/Hat-05---Crown-p-500.png 500w, images/Hat-05---Crown-p-800.png 800w, images/Hat-05---Crown.png 1000w" alt="" className="llama-img select dis" /></div>
                </div>
