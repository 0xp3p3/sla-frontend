...
export const WalletMultiButton: FC<ButtonProps> = ({ children, ...props }) => {
    ...
    if (!wallet) return <WalletModalButton dontUseDefaultStyle={true} {...props}>{children}</WalletModalButton>;
    if (!base58) return <WalletConnectButton dontUseDefaultStyle={true} {...props}>{children}</WalletConnectButton>;

    return (
        <div className="wallet-adapter-dropdown">
            <Button
                dontUseDefaultStyle={true}
