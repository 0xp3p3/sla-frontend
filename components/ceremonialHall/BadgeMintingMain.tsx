      ...
      <div id="w-node-_1e5206db-e4c0-6d6c-91fd-4943b60221eb-e7db2ab3" className="vert-left space-btw h-700">
        <div className="vert-left marg-mob">
          ...
          {currentBadgeInfo.bronzeSupply &&
            <h3 className="h3 h-white mrg-d-34">Supply Left: {currentBadgeInfo.bronzeSupply.toLocaleString("en-US")}<br />+{SLA_BRONZE_BADGE.bonusHay} bonus $HAY</h3>
          }
      ...
      <div id="w-node-_18afe3ea-d09d-a4a9-d75b-940fffa9d6df-e7db2ab3" className="vert-left space-btw h-700">
        <div className="vert-left marg-mob">
          ...
          {currentBadgeInfo.silverSupply &&
            <h3 className="h3 h-white mrg-d-34">Supply Left: {currentBadgeInfo.silverSupply.toLocaleString("en-US")}<br />+{SLA_SILVER_BADGE.bonusHay} Bonus $HAY</h3>
          }
      ...
      <div id="w-node-_82f835ae-4110-40a3-fcac-b2b115de4b1c-e7db2ab3" className="vert-left space-btw h-700">
        <div className="vert-left marg-mob">
          ...
          {currentBadgeInfo.goldSupply &&
            <h3 className="h3 h-white mrg-d-34">Supply Left: {currentBadgeInfo.goldSupply.toLocaleString("en-US")}<br />+{SLA_GOLD_BADGE.bonusHay} Bonus $HAY</h3>
          }
      ...
      <div id="w-node-_5d0b1d89-fa1c-6041-1a9c-2c99ee13eb02-e7db2ab3" className="vert-left space-btw h-700">
        <div className="vert-left marg-mob">
          ...
          {currentBadgeInfo.platinumSupply &&
            <h3 className="h3 h-white mrg-d-34">Supply Left: {currentBadgeInfo.platinumSupply.toLocaleString("en-US")}<br />+{SLA_PLATINUM_BADGE.bonusHay} Bonus $HAY</h3>
          }
      ...
      <div id="w-node-b3720fa6-9655-bf96-17d8-a8304b6f5463-e7db2ab3" className="vert-left space-btw h-700">
        <div className="vert-left marg-mob">
          ...
          {currentBadgeInfo.diamondSupply &&
            <h3 className="h3 h-white mrg-d-34">Supply Left: {currentBadgeInfo.diamondSupply.toLocaleString("en-US")}<br />+{SLA_DIAMOND_BADGE.bonusHay} Bonus $HAY</h3>
          }
