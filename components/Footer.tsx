          ...
          <div className="absolute-div">
            <div className="footer-links">
              ...
              <div className="vert-left">
                ...
                <a href="/documents/Whitepaper.pdf" target="_blank" className="tb-15 foot-link">WHITE PAPER</a>
                <Link href="/terms"><a aria-current="page" className="tb-15 foot-link _4 w--current">TERMS &amp; CONDITIONS</a></Link>
              </div>
            </div>
            <div className="foot-socials">
              <a href="https://www.tiktok.com/@secretllamaagency" target="_blank" className="social-link footer-link w-inline-block"><img src="images/Vector-17.svg" loading="lazy" alt="" className="socials-img" /></a>
              <a href="https://discord.gg/5STFvY9nu5" target="_blank" className="social-link footer-link w-inline-block"><img src="images/Vector-16.svg" loading="lazy" alt="" className="socials-img" /></a>
              <a href="https://twitter.com/SecretLlama_A" target="_blank" className="social-link footer-link w-inline-block"><img src="images/Vector-15.svg" loading="lazy" alt="" className="socials-img" /></a>
              <a href="https://www.instagram.com/secretllamaagency/" target="_blank" className="social-link _4 footer-link w-inline-block"><img src="images/Vector-14.svg" loading="lazy" alt="" className="socials-img" /></a>
            </div>
          </div>
        </div>
      </div>
